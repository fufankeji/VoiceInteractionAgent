...
class TTS:
    ...
    def init_cnhuhbert_weights(self, base_path: str):
        ...
        if self.configs.is_half and str(self.configs.device) != "cuda":
    ...
    def enable_half_precision(self, enable: bool = True, save: bool = True):
        ...
        """
        if str(self.configs.device) == "cuda" and enable:
            print("Half precision is not supported on cuda.")
            return
    ...
    def using_vocoder_synthesis(
        ...
        with torch.inference_mode():
            ...
            audio = wav_gen[0][0]  # .cuda().detach().numpy()
